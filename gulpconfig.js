...
// Project paths
var project = 'forge', // The directory name for your theme; change this at the very least!
...
module.exports = {
	...
	browsersync: {
		...
		proxy: 'localhost/forge', // We need to use a proxy instead of the built-in server because WordPress has to do some server-side rendering for the theme to work
		watchOptions: {
	...
	scripts: {
		...
		chunks: { // Chunks are arrays of paths or globs matching a set of source files; this way you can organize a bunch of scripts that go together into pieces that can then be bundled (above)
			...
			pg8: [
				...
				, modules + 'spin.js/spin.js', modules + 'spin.js/jquery.spin.js', modules + 'wp-ajax-page-loader/wp-ajax-page-loader.js'
			]
		},
	...
	styles: {
		...
		}, // This tool is magic and you should use it in all your projects :)
		minify: {
