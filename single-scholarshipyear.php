<?php
/**
 * Template Name: Scholarship Year
 * Description: Page for displaying scholarship yearly recipients
 * Template Post Type: scholarship_year
 *
 */
...
if ( have_posts() ) :
	while ( have_posts() ) :
		...
		get_template_part( 'content', 'scholarshipyear' );
